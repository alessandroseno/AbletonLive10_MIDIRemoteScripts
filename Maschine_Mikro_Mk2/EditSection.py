# Embedded file name: C:\ProgramData\Ableton\Live 9 Suite\Resources\MIDI Remote Scripts\Maschine_Mikro_Mk2\EditSection.py
...
class EditSection(CompoundComponent):
    ...
    def _get_current_slot(self, song):
        ...
        return (
         clip_slot, track, scenes, tindex, sindex)
