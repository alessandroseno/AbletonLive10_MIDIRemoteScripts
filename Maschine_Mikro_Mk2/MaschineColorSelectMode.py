# Embedded file name: C:\ProgramData\Ableton\Live 9 Suite\Resources\MIDI Remote Scripts\Maschine_Mikro_Mk2\MaschineColorSelectMode.py
...
LIVE_COLOR_SET = (15549221, 12411136, 11569920, 8754719, 5480241, 695438, 31421, 197631,
                  3101346, 6441901, 8092539, 3947580, 16712965, 12565097, 10927616,
                  8046132, 4047616, 49071, 1090798, 5538020, 8940772, 10701741, 12008809,
                  9852725, 16149507, 12581632, 8912743, 1769263, 2490280, 6094824,
                  1698303, 9160191, 9611263, 12094975, 14183652, 16726484, 16753961,
                  16773172, 14939139, 14402304, 12492131, 9024637, 15810688, 8962746,
                  10204100, 8758722, 13011836, 16749734, 16753524, 16772767, 13821080,
                  12243060, 11119017, 13958625, 13496824, 12173795, 13482980, 13684944,
                  14673637, 16777215, 15549221, 12411136, 11569920, 8754719)
BASE_COLOR_TABLE = (
 (115, 127, 127, 16726484), (124, 73, 127, 15810688), (3, 127, 118, 15549221), (0, 125, 127, 16712965),
 (81, 110, 114, 5538020), (85, 126, 127, 197631), (90, 115, 124, 8940772), (105, 115, 114, 14183652),
 (33, 100, 127, 8912743), (44, 124, 119, 1769263), (55, 119, 127, 2490280), (67, 110, 127, 6094824),
 (9, 125, 123, 16149507), (12, 107, 127, 16753961), (17, 120, 127, 16773172), (24, 118, 110, 14939139))
BASE_COLOR_TABLE_2 = (
 (0, 127, 127, 16712965), (9, 125, 123, 16149507), (12, 107, 127, 16753961), (20, 57, 120, 16772767),
 (20, 127, 127, 14939139), (33, 120, 127, 8912743), (39, 120, 127, 1769263), (46, 127, 90, 5480241),
 (50, 127, 127, 2490280), (62, 127, 127, 6094824), (74, 127, 127, 9160191), (85, 126, 127, 197631),
 (91, 127, 107, 10701741), (111, 127, 127, 16726484), (124, 127, 107, 12008809), (127, 86, 127, 16749734))
MColorMode = 1
...
class MaschineColorSelectMode(MaschineMode):
    ...
    def __init__(self, button_index, *a, **k):
        ...
        for c in BASE_COLOR_TABLE:
            color = (
             (
              c[0], c[1], c[2]), (c[0], c[1], max(c[2] - 100, 10)))
            list.append(color)
