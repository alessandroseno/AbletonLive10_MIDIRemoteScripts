# Embedded file name: C:\ProgramData\Ableton\Live 9 Suite\Resources\MIDI Remote Scripts\Maschine_Mikro_Mk2\ControlMode.py
...
CM_SEND = 2
CM_DEVICE = 3
BASIC_COLORS = (PColor.MIX_MODE_VOLUME, PColor.MIX_MODE_PANNING, PColor.MIX_MODE_SEND, PColor.MIX_MODE_DEVICE)
N_PARM_RANGE = 127
    ...
    def _do_track_selection(self, button_index):
        ...
        if self._mode == CM_DEVICE:
            ...
            if self._in_clear_mode and track_sel._track:
                ...
                if button_index != self._track_sel_index and track_sel._track:
                    current.turn_off()
                    track_sel.turn_on()
                    current = track_sel
