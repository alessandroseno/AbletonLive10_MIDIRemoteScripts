# Embedded file name: C:\ProgramData\Ableton\Live 9 Suite\Resources\MIDI Remote Scripts\Maschine_MK3\PadColorButton.py
# Compiled at: 2017-08-10 18:34:01
from _Framework.ButtonElement import ButtonElement
from _Framework.InputControlElement import InputControlElement
from _Framework.InputControlElement import MIDI_NOTE_TYPE, MIDI_NOTE_ON_STATUS, MIDI_CC_STATUS
from MidiMap import NON_FEEDBACK_CHANNEL, debug_out
from Constants import MATRIX_NOTE_NR, COLOR_BLACK
...
class PadColorButton(ButtonElement):
    ...
    def __init__(self, is_momentary, channel, row_index, column_index, color_source):
        ButtonElement.__init__(self, is_momentary, MIDI_NOTE_TYPE, channel, MATRIX_NOTE_NR - row_index * 4 + column_index)
...
class IndexedButton(ButtonElement):
    ...
    def __init__(self, is_momentary, midi_type, identifier, channel, color_list):
        ...
        self.__note_on_code = MIDI_CC_STATUS | channel
