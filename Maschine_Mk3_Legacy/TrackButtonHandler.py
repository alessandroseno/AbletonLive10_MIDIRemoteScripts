# Embedded file name: C:\ProgramData\Ableton\Live 9 Suite\Resources\MIDI Remote Scripts\Maschine_MK3\TrackButtonHandler.py
# Compiled at: 2017-09-17 22:24:17
...
class TrackButtonHandler(CompoundComponent):
    ...
    def update_value(self, blink_state=0):
        if not self._button.grabbed and self._valueupdater:
    ...
    @subject_slot('value')
    def _handle_button_value(self, value):
        if not self._button.grabbed and value > 0 and self._action:
