# Embedded file name: C:\ProgramData\Ableton\Live 9 Suite\Resources\MIDI Remote Scripts\Maschine_MK3\ParameterUtil.py
# Compiled at: 2017-09-20 23:08:03
import Live, re
...
def shorten_devname(name):
    ...
    rstr = ''
    if len(splt) > 1:
        splt = map(lambda s: filter_vowels(s, 7), splt)
        rstr = rstr.join(splt)
        if len(rstr) > 8:
...
DEVICE_SHORT_NAMES = {'AutoFilter': 'AutoFLTR', 
   'BeatRepeat': 'Beat RPT', 
...
DEVICE_MAP = {'Amp': (
   ...
   'FilterDelay': {'bankGroups': (0, 2, 4), 'params': (
                            (
                             (1, 'Input On', 'DELAY 1'),
                             (
   ...
   'Looper': (
            ...
            None), 
   'MultibandDynamics': {'bankGroups': (0, 1, 6, 12), 'params': (
                                  (
                                   (1, 'Lo-Mi X-', 'MB COMP'),
                                   (2, 'MI-HI X-'),
                                   (
   ...
   'Vocoder': (
             ...
             (
              ...
              (23, 'Gain', 'EXT IN'))), 
   'Operator': {'bankGroups': (0, 1, 5, 9, 13, 17, 21, 24), 'params': (
                         (
                          (
                           1, 'Algorith', 'MAIN', ('D>C>B>A', 'D-C>B>A', 'C>B+D)>A', 'D>C-B)>A', 'D>C>B-A', 'A+D>C>B', 'D-C-B>A', 'D>C+B>A',
 'D>C-B-A', 'A+B+D>C', 'A+B+C+D')),
                          (2, 'Transpos'),
                          (
                           3, DEF_NAME),
                          (
   ...
   'OriginalSimpler': (
                     ...
                     (
                      ...
                      (19, 'Pan<Rnd'),
                      (20, 'Pan<LFO'))), 
   'UltraAnalog': {'bankGroups': (0, 2, 4, 5, 7, 9, 11, 13, 16, 19, 21, 23), 'params': (
                            (
                             (29, 'On/Off', 'OSC 1'),
                             (
                            ...
                            (
                             ...
                             (23, 'GlideMod'),
                             (24, 'GlideLeg')))}, 
   'Collision': {'bankGroups': (0, 1, 3, 5, 10, 15, 17), 'params': (
                          (
                           (
   ...
   'LoungeLizard': (
                  ...
                  (
                   ...
                   (31, 'Damp Am'),
                   (32, 'Damp Bal'))), 
   'InstrumentImpulse': {'bankGroups': (0, 1, 4, 7, 10, 13, 16, 19, 22), 'params': (
                                  (
                                   (1, 'GLVolume'),
                                   (
                                    2, DEF_NAME),
                                  ...
                                  (
                                   ...
                                   (162, 'Volume'),
                                   (163, 'VOL<VEL')))}, 
   'MultiSampler': {'bankGroups': (0, 5), 'params': (
                             (
                              (
   ...
   'StringStudio': {'bankGroups': (0, 4, 6, 8, 10, 11, 14), 'params': (
                             (
                              (
                             ...
                             (
                              ...
                              (53, 'Damping'),
                              (
                               29, 'FIX POS', None, ('OFF', 'ON')),
                              (
                               54, ' Gated', None, ('OFF', 'ON'))),
                             (
                              (48, 'Mass<KEY', 'DAMPER MD'),
                              (50, 'Stiff<KE'),
                              (52, 'Velo<KEY'),
                              (30, 'Pos<Key'),
                              (31, 'Pos<Vel')),
                             (
                              (
                               44, 'On/Off', 'PICK', ('OFF', 'ON')),
                              (45, 'Position'),
                              (
                               61, 'On/Off', 'TREMOLO', ('OFF', 'ON')),
                              (62, 'Fng.Stiff'),
                              (63, 'Mass'),
                              (64, 'Mas<Key'),
                              (65, 'Mas<Vel'),
