# Embedded file name: C:\ProgramData\Ableton\Live 9 Suite\Resources\MIDI Remote Scripts\Maschine_MK3\MaschineSessionComponent.py
# Compiled at: 2017-09-17 22:37:26
from MidiMap import toHSB, debug_out
from Constants import STEP1, COLOR_BLACK, COLOR_WHITE, COLOR_WHITE_DIM
from _Framework.SessionComponent import SessionComponent
from MaschineSceneComponent import MaschineSceneComponent
COLOR_MODE_WHITE = 1
COLOR_MODE_STD = 0
...
class MaschineSessionComponent(SessionComponent):
    ...
    __matrix = None
    __matrix_lookup = []
    scene_component_type = MaschineSceneComponent
    _track_offset_listener = None
    _advance = STEP1
    __color_mode = COLOR_MODE_STD

    def __init__(self, *a, **k):
        super(MaschineSessionComponent, self).__init__(4, 4, *a, **k)
        self.__to_std_cmode()
    ...
    def set_offsets(self, track_offset, scene_offset):
        ...
        super(MaschineSessionComponent, self).set_offsets(track_offset, scene_offset)
        if prevoffset != track_offset and self._track_offset_listener:
    ...
    def disconnect(self):
        super(MaschineSessionComponent, self).disconnect()
