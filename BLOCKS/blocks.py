# Embedded file name: /Users/versonator/Jenkins/live/output/mac_64_static/Release/python-bundle/MIDI Remote Scripts/BLOCKS/blocks.py
...
class Blocks(ControlSurface):
    ...
    def _create_controls(self):
        self._pads_raw = [ ButtonElement(True, MIDI_NOTE_TYPE, 0, identifier, name=('Pad_{}').format(identifier), skin=skin) for identifier in xrange(100)
                         ]
        ...
        self._scene_launch_button_matrix = ButtonMatrixElement(rows=[[ self._pads_raw[identifier] for identifier in xrange(89, 58, -10) ]], name='Scene_Launch_Button_Matrix')
        ...
        self._tempo_encoder = EncoderElement(MIDI_PB_TYPE, 0, 0, Live.MidiMap.MapMode.absolute, name='Tempo_Encoder')
    ...
    def _create_modes(self):
        ...
        self._note_modes.add_mode('melodic', [
         partial(self._send_mode_message, 'melodic'),
         self._melodic_pad_translator])
        self._note_modes.add_mode('disabled', [
         partial(self._send_mode_message, 'disabled')])
