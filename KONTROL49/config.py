...
BANK_CONTROLS = {'TOGGLELOCK': GENERIC_BUT9, 
   ...
   'PREVBANK': GENERIC_PAD1, 'BANK1': 47, 
   'BANK2': 46, 'BANK3': 45, 'BANK4': 44, 'BANK5': 85, 
   'BANK6': 86, 'BANK7': 87, 'BANK8': 88}
PAD_TRANSLATION = (
...
CONTROLLER_DESCRIPTIONS = {'INPUTPORT': 'KONTROL49 (PORT B)', 'OUTPUTPORT': 'KONTROL49 (CTRL)', 
   'CHANNEL': 7, 'PAD_TRANSLATION': PAD_TRANSLATION}
