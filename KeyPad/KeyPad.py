...
pads = [
 ...
 5, 6, 7, 8,
 13, 14, 15, 16]
PAD_TRANSLATIONS = tuple([ (n % 4, 3 - n / 4, pads[n] + 35, 4) for n in xrange(16) ])
...
class KeyPad(ControlSurface):
    ...
    def _setup_session(self):
        ...
        stop_buttons = ButtonMatrixElement(name='Track_Stop_Buttons', rows=[
         self._shifted_solo_buttons])
