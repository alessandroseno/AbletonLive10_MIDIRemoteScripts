...
BANK_CONTROLS = {'TOGGLELOCK': GENERIC_BUT9, 
   ...
   'PREVBANK': GENERIC_PAD1, 'BANK1': (47, 1), 
   'BANK2': (46, 8), 'BANK3': (45, 8), 'BANK4': (44, 8), 'BANK5': (85, 8), 
   'BANK6': (86, 8), 'BANK7': (87, 8), 'BANK8': (88, 8)}
PAD_TRANSLATION = (
...
CONTROLLER_DESCRIPTIONS = {'INPUTPORT': 'microKONTROL (PORT B)', 'OUTPUTPORT': 'microKONTROL (CTRL)', 
   'CHANNEL': 8, 'PAD_TRANSLATION': PAD_TRANSLATION}
