...
class PushBase(ControlSurface):
    ...
    def _create_alternating_layout_modes_for_64pads(self, mode='drum', add_touch_strip=False, default_mode=None, alternative_mode=None):
        ...
        alternating_layouts.add_mode('64pads', [
         AddLayerMode(base_component, Layer(matrix='matrix'))] + touch_strip_modes, default_mode=default_mode, alternative_mode=alternative_mode)
    ...
    def _create_slicing_modes(self):
        ...
        self._register_matrix_mode('64pads', modes_component=self._slicing_64pads_modes, parent_path=[
        ...
        self._register_matrix_mode('sequencer_loop', modes_component=self._slicing_64pads_modes, parent_path=[
         'matrix_modes', 'note', 'slicing'])
        ...
        self._register_matrix_mode('sequencer_velocity_levels', modes_component=self._slicing_64pads_modes, parent_path=[
         'matrix_modes', 'note', 'slicing'])
    ...
    def _create_drum_modes(self):
        ...
        self._register_matrix_mode('sequencer_loop', modes_component=self._drum_loop_modes, parent_path=[
        ...
        self._register_matrix_mode('sequencer_velocity_levels', modes_component=self._drum_loop_modes, parent_path=[
         'matrix_modes', 'note', 'drums'])
        drum_modes.add_mode('64pads', self._drum_64pads_modes, message=consts.MessageBoxText.LAYOUT_DRUMS_64_PADS)
        self._register_matrix_mode('64pads', modes_component=self._drum_loop_modes, parent_path=[
         'matrix_modes', 'note', 'drums'])
    ...
    def _init_matrix_modes(self):
        ...
        self._note_modes.add_mode('drums', [
         self._drum_component,
         self._note_repeat_enabler,
         self._drum_modes])
        self._register_matrix_mode('drums', modes_component=self._drum_modes, parent_path=[
         'matrix_modes', 'note'])
        self._note_modes.add_mode('slicing', [
         self._slicing_component,
         self._note_repeat_enabler,
         self._slicing_modes])
        self._register_matrix_mode('slicing', modes_component=self._slicing_modes, parent_path=[
         'matrix_modes', 'note'])
        ...
        self._register_matrix_mode('instrument', modes_component=self._instrument, parent_path=[
         'matrix_modes', 'note'])
        self._note_modes.add_mode('disabled', self._matrix_background)
        self._register_matrix_mode('disabled', parent_path=[
         'matrix_modes', 'note'])
        ...
        self._register_matrix_mode('note', modes_component=self._note_modes, parent_path=[
         'matrix_modes'])
    ...
    def _create_sequence_instrument_layer(self):
        return Layer(accent_button='accent_button', full_velocity='full_velocity_element', playhead='playhead_element', mute_button='global_mute_button', quantization_buttons='side_buttons', note_editor_matrices=ButtonMatrixElement([[ self.elements.matrix.submatrix[:, 7 - row] for row in xrange(8) ]]), duplicate_button='duplicate_button', delete_button='delete_button')

    def _create_sequence_instrument_layer_with_loop(self):
        return Layer(playhead='playhead_element', mute_button='global_mute_button', quantization_buttons='side_buttons', loop_selector_matrix=self.elements.double_press_matrix.submatrix[:, 0], short_loop_selector_matrix=self.elements.double_press_event_matrix.submatrix[:, 0], note_editor_matrices=ButtonMatrixElement([[ self.elements.matrix.submatrix[:, 7 - row] for row in xrange(7) ]]), duplicate_button='duplicate_button', delete_button='delete_button')
    ...
    def _init_instrument(self):
        ...
        self._register_matrix_mode('play', self._instrument.play_modes, parent_path=[
         'matrix_modes', 'note', 'instrument'])
        self._register_matrix_mode('sequence', self._instrument.sequence_modes, parent_path=[
         'matrix_modes', 'note', 'instrument'])
    ...
    def _init_split_melodic_sequencer(self):
        ...
        self._register_matrix_mode('split_melodic_sequencer', modes_component=self._split_sequencer_mode, parent_path=[
         'matrix_modes', 'note', 'instrument'])
