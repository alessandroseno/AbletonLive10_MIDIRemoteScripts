# Embedded file name: C:\ProgramData\Ableton\Live 10 Suite\Resources\MIDI Remote Scripts\Maschine_JAM\EncoderHandler.py
...
class EncoderHandler(CompoundComponent):
    ...
    def refresh(self):
        if self._parameter is not None and self._track is None:
            self._encoder.set_display_value(self._parm_to_midi(), True)
        return
