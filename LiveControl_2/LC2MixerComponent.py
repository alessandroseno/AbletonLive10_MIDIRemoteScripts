...
# Embedded file name: /Applications/Ableton Live 9 Suite.app/Contents/App-Resources/MIDI Remote Scripts/LiveControl_2_1_31/LC2MixerComponent.py
...
class LC2MixerComponent(MixerComponent):
    ...
    def handle_sysex(self, sysex):
        cmds = [
         self._select_device, self._device_bank, self._set_routing, self._select_track]
        if sysex[0] < len(cmds):
