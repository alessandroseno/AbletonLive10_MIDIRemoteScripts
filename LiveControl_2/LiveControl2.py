...
# Embedded file name: /Applications/Ableton Live 9 Suite.app/Contents/App-Resources/MIDI Remote Scripts/LiveControl_2_1_31/LiveControl2.py
...
class LiveControl2(ControlSurface):
    ...
    def handle_sysex(self, sysex):
        ...
        pages = [
         self._session, self._mixer, self._sequencer, self._modulator]
        for sysex in msysex:
            if len(sysex) > 1:
                if sysex[1] == 5:
                    if sysex[2] == 1:
