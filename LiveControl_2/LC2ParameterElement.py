...
# Embedded file name: /Applications/Ableton Live 9 Suite.app/Contents/App-Resources/MIDI Remote Scripts/LiveControl_2_1_31/LC2ParameterElement.py
...
class LC2ParameterElement(SliderElement):
    ...
    def settings(self):
        if self._parameter_to_map_to is not None:
            ...
            return [
             unicode(parent.name), unicode(self._parameter_to_map_to.name)]
        return [
         '', '']
        return