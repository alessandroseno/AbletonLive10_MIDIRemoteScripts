# Embedded file name: /Users/versonator/Jenkins/live/output/mac_64_static/Release/python-bundle/MIDI Remote Scripts/Push2/eq8.py
...
class Eq8DeviceDecorator(EventObject, LiveObjectDecorator):
    ...
    def __init__(self, *a, **k):
        ...
        self.left_right_curve_switch_option = DeviceSwitchOption(name='Left/Right', labels=[
         'Left', 'Right'], parameter=self.edit_switch)
        self.mid_side_curve_switch_option = DeviceSwitchOption(name='Mid/Side', labels=[
         'Mid', 'Side'], parameter=self.edit_switch)
