# Embedded file name: /Users/versonator/Jenkins/live/output/mac_64_static/Release/python-bundle/MIDI Remote Scripts/Push2/wavetable.py
...
class WavetableDeviceComponent(DeviceComponentWithTrackColorViewData):
    ...
    VISUALISATION_CONFIGURATION = {'wavetable': {'position_in_banks': {0: ButtonRange(0, 2), 
                     ...
                     'visible_in_bank': lambda component, bank: component.selected_oscillator in [
                                       WavetableOscillatorType.one,
                                       WavetableOscillatorType.two]}, 
       'filter': {'position_in_banks': {0: ButtonRange(3, 5), 
                                        2: ButtonRange(2, 4)}}, 
    ...
    def __init__(self, *a, **k):
        ...
        self._delete_default_component = self.register_component(WavetableDeleteComponent(name='DeleteAndDefault'))
