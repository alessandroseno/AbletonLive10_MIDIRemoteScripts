...
BANK_CONTROLS = {'TOGGLELOCK': GENERIC_BUT9, 
   'BANKDIAL': -1, 
   'NEXTBANK': -1, 
   'PREVBANK': -1, 'BANK1': GENERIC_PAD1, 
   'BANK2': GENERIC_PAD2, 'BANK3': GENERIC_PAD3, 'BANK4': GENERIC_PAD4, 'BANK5': GENERIC_PAD5, 
   'BANK6': GENERIC_PAD6, 'BANK7': GENERIC_PAD7, 'BANK8': GENERIC_PAD8}
