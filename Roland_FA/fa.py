# Embedded file name: /Users/versonator/Jenkins/live/output/mac_64_static/Release/python-bundle/MIDI Remote Scripts/Roland_FA/fa.py
...
class FA(ControlSurface):
    ...
    def _create_controls(self):
        ...
        self._encoders = ButtonMatrixElement(rows=[
         [ make_encoder(index + 70, 'Encoder_%d' % (index,)) for index in xrange(6)
         ]], name='Encoders')
