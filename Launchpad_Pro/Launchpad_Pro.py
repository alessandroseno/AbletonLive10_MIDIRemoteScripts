...
class MidiMap(SpecialMidiMap):
    ...
    def __init__(self, *a, **k):
        ...
        left_button_names = (u'Session_Record_Button', u'Double_Loop_Button', u'Duplicate_Button',
                             u'Quantize_Button', u'Delete_Button', u'Undo_Button',
                             u'Click_Button', u'Shift_Button')
        ...
        self.add_matrix('Main_Button_Matrix', make_button, 0, [ [ identifier for identifier in xrange(start, start + NUM_TRACKS) ] for start in xrange(81, 10, -10)
                                                              ], MIDI_NOTE_TYPE)
        ...
        self['Note_Button_Matrix'] = ButtonMatrixElement(rows=[
         note_buttons_raw], name='Note_Button_Matrix')
    ...
    def with_shift(self, button_name):
        return ComboElement(self[button_name], modifiers=[
         self['Shift_Button']], name='Shifted_' + button_name)
