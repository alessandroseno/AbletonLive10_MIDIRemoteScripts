...
BANK_DEFINITIONS = {'AudioEffectGroupDevice': RACK_BANKS, 
   ...
   'InstrumentImpulse': IndexedDict((
                       ...
                       (
                        '1 Filt/Mod/Pan',
                        {PARAMETERS_KEY: (
                                          '1 Filter Freq', '1 Filter Res', '1 Filter Type', '1 Filter <- Vel',
                       ...
                       (
                        '2 Filt/Mod/Pan',
                        {PARAMETERS_KEY: (
                                          '2 Filter Freq', '2 Filter Res', '2 Filter Type', '2 Filter <- Vel',
                       ...
                       (
                        '3 Filt/Mod/Pan',
                        {PARAMETERS_KEY: (
                                          '3 Filter Freq', '3 Filter Res', '3 Filter Type', '3 Filter <- Vel',
                       ...
                       (
                        '4 Filt/Mod/Pan',
                        {PARAMETERS_KEY: (
                                          '4 Filter Freq', '4 Filter Res', '4 Filter Type', '4 Filter <- Vel',
                       ...
                       (
                        '5 Filt/Mod/Pan',
                        {PARAMETERS_KEY: (
                                          '5 Filter Freq', '5 Filter Res', '5 Filter Type', '5 Filter <- Vel',
                       ...
                       (
                        '6 Filt/Mod/Pan',
                        {PARAMETERS_KEY: (
                                          '6 Filter Freq', '6 Filter Res', '6 Filter Type', '6 Filter <- Vel',
                       ...
                       (
                        '7 Filt/Mod/Pan',
                        {PARAMETERS_KEY: (
                                          '7 Filter Freq', '7 Filter Res', '7 Filter Type', '7 Filter <- Vel',
                       ...
                       (
                        '8 Filt/Mod/Pan',
                        {PARAMETERS_KEY: (
                                          '8 Filter Freq', '8 Filter Res', '8 Filter Type', '8 Filter <- Vel',
   ...
   'Operator': IndexedDict((
              ...
              (
               'Global',
               {PARAMETERS_KEY: (
                                 'Time', 'Time < Key', 'Tone', 'Algorithm',
                                 'Panorama', 'Pan < Key', 'Pan < Rnd', 'Volume')}),
              (
               'Osc. A',
               {PARAMETERS_KEY: (
                                 'Osc-A On',
   ...
   'OriginalSimpler': IndexedDict((
                     ...
                     (
                      ...
                      {PARAMETERS_KEY: (
                                        ...
                                        'Voices', 'Transpose', 'Detune', 'Vol < Vel',
                                        'Gain', 'Volume')}),
                     (
                      'Volume Envelope',
                      {PARAMETERS_KEY: (
                                        ...
                                        'Filt < Vel', 'Vol < Vel', 'Vol < LFO', 'Volume')}),
                     (
                      'Warp',
                      {PARAMETERS_KEY: (
   ...
   'Echo': IndexedDict((
          (
           ...
           {PARAMETERS_KEY: (
                             ...
                             'HP Freq', 'LP Freq', 'Feedback', 'Input Gain', 'Dry Wet')}),
          (
           'L/Mid',
           {PARAMETERS_KEY: (
                             use('L Time').with_name('M Time').if_parameter('Channel Mode').has_value('Mid/Side').and_parameter('L Sync').has_value('Off').else_use('L Time').if_parameter('L Sync').has_value('Off').else_use('L 16th').with_name('M 16th').if_parameter('Channel Mode').has_value('Mid/Side').and_parameter('L Sync Mode').has_value('16th').else_use('L 16th').if_parameter('L Sync Mode').has_value('16th').else_use('L Division').with_name('M Division').if_parameter('Channel Mode').has_value('Mid/Side').else_use('L Division'),
                             ...
                             'Link', 'Feedback', 'Feedback Inv', 'Dry Wet')}),
          (
           'R/Side',
           {PARAMETERS_KEY: (
          ...
          (
           'Global',
           {PARAMETERS_KEY: (
                             'Repitch', 'Channel Mode', 'Stereo Width', '',
                             'Clip Dry', 'Input Gain', 'Output Gain', 'Dry Wet')}),
          (
           'Filter',
           {PARAMETERS_KEY: (
          ...
          (
           ...
           {PARAMETERS_KEY: (
                             ...
                             'Mod Phase', 'Env Mix', 'Dly < Mod', 'Flt < Mod', 'Mod 4x')}),
          (
           'Reverb',
           {PARAMETERS_KEY: (
                             'Reverb Level', 'Reverb Loc', 'Reverb Decay', '',
                             '', '', '', '')}),
          (
           'Gate/Ducking',
           {PARAMETERS_KEY: (
   ...
   'Eq8': IndexedDict((
         ...
         (
          '8 x Resonance',
          {PARAMETERS_KEY: (
                            '1 Resonance A', '2 Resonance A', '3 Resonance A', '4 Resonance A',
                            '5 Resonance A', '6 Resonance A', '7 Resonance A', '8 Resonance A')}))), 
   ...
   'MultibandDynamics': IndexedDict((
                       ...
                       (
                        ...
                        {PARAMETERS_KEY: (
                                          ...
                                          'Peak/RMS Mode', 'Amount', 'Master Output')}),
                       (
                        'Sidechain',
                        {PARAMETERS_KEY: (
                                          'S/C On',
   ...
   'Phaser': IndexedDict((
            ...
            (
             ...
             {PARAMETERS_KEY: (
                               ...
                               'Frequency', 'Feedback', 'Env. Modulation', 'Env. Attack', 'Env. Release')}),
            (
             'LFO',
             {PARAMETERS_KEY: (
                               'LFO Amount', 'LFO Waveform', 'LFO Sync',
   ...
   'Reverb': IndexedDict((
            ...
            (
             ...
             {PARAMETERS_KEY: (
                               ...
                               'Quality', 'Freeze On', 'Flat On', 'ER Level', 'Diffuse Level')}),
            (
             'Diffusion Network',
             {PARAMETERS_KEY: (
                               'HiShelf On',
   ...
   'Vocoder': IndexedDict((
             ...
             (
              'Carrier',
              {PARAMETERS_KEY: (
                                'Noise Rate', 'Noise Crackle', 'Upper Pitch Detection', 'Lower Pitch Detection',
                                'Oscillator Pitch', 'Oscillator Waveform', '', '')}),
             (
              'Global',
              {PARAMETERS_KEY: (
...
PARAMETERS_BLACKLIST_FOR_CPP_SANITY_CHECK = {'OriginalSimpler': (
                     ...
                     'Playback', 'Pad Slicing', 'Multi Sample', 'Warp',
                     'Warp Mode', 'Voices', 'Preserve', 'Loop Mode',
                     'Envelope', 'Grain Size Tones', 'Grain Size Texture',
                     'Flux', 'Formants', 'Envelope Complex Pro', 'Gain'), 
   'InstrumentVector': (
                      'Osc 1 Effect Type', 'Osc 2 Effect Type', 'Osc 1 Table', 'Osc 2 Table',
                      'Osc 1 Category', 'Osc 2 Category', 'Osc 1 Pitch', 'Osc 2 Pitch',
                      'Unison Mode', 'Mono On')}
